...
# 매일 자정 크롤링
sched.add_job(crawlingKobusEveryDay, 'cron', minute="19", second="0", hour="0",id="kobusCrawlingJob")
sched.add_job(crawlingTmoneyBusEveryDay, 'cron', minute="19", second="0", hour="0", id="tmoneybusCrawlingJob")
